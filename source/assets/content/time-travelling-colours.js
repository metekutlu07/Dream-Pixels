export default {
	...
	sections: [
		...
		},
		{
			type: 'S2',
			title: 'Introduction',
			paragraphs: 'Hi, my name is Mete Kutlu. I’m an architect who explores a unique vision of space that is shared by digital architecture and oriental miniature paintings. Both my research and design works are based on a jump in space-time between artisanal and digital cultures of architectural space. By short-circuiting 500 years of modernity, the luminous colors of the miniatures offer us an invaluable historical reference point. As for my method, it combines historical studies with a process of digital experimentation. I try to build new relationships between art history, technology and architecture.'
		},
		{
			type: 'S3',
		...
		{
			type: 'S2',
			title: 'How does the miniatures relate to our visual culture in the Digital Age? ',
