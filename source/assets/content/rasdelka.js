	...
	sections: [
		{
			...
			media: {
				...
				caption: 'Rasdelka Video Introduction'
			}
		},
		{
			type: 'S2',
			paragraphs: 'Rasdelka is a digital experiment that investigates the spatial logic of Byzantine miniature painting through the concept of apophatic representation. The project is based on the hypothesis that architectural forms in these images do not aim to reproduce physical reality, but to express a metaphysical order that exceeds direct perception. The experiment focuses on a miniature of an unidentified church, produced in Constantinople in the eleventh century and preserved today in the Vatican Apostolic Library. Buildings are constructed through distortion, inconsistency, and fragmentation, forming images that resist stable interpretation. The experiment analyzes this miniature and translates its structure into a 3D model. The architectural elements are reconstructed and reorganized to reveal their internal contradictions, including shifting orientations, disproportionate volumes, and discontinuous surfaces. These operations expose a non-Euclidean spatial system in which geometry is used to negate rather than affirm form. The resulting model interprets architecture as a field of signs, where distortion becomes a method for encoding invisible and transcendent realities.',
		},
		{
			type: 'S9',
			media: {
		...
		},
		{
			...
			media: {
				...
				tags: [ '3D Miniature', 'Byzantine', 'Miniatures', 'Painting' ],
				caption: 'Digital reconstruction of the Byzantine church, Mete Kutlu, 2020.',
				explain: 'Rather than following a regular geometric plan, the church emerges as a spontaneous, almost natural accumulation of volumes of varying sizes and shapes. The irregular rhythm of domes and walls suggests a living form, growing like an organism rather than a rigid architectural scheme. Based on the frontispiece miniature of the <em>Lectionary 120,</em> Constantinople, 11th century. Vatican Apostolic Library, Vat. gr. 1156, fol. 1r, Vatican City. '
			}
		},
		{
			type: 'S9',
