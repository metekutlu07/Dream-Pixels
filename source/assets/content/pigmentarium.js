	...
	sections: [
		{
			type: 'S1',
			media: {
				source: 'public/pigmentarium/comp.mp4',
		...
		{
			type: 'S2',
			paragraphs: 'Pigmentarium is a computational experiment that examines how images function as systems of knowledge rather than representations. It is grounded in the alchemical principle at the core of miniature painting: the capacity to perceive, within a single grain of pigment, the genesis of entire worlds. The miniature operates through a fluid and non-linear vision in which atom and cosmos reflect one another, forming a cosmogony of colors. Through particle simulation and computational fluid dynamics, this vision is made visible. Pigments are discretized into particles and subjected to turbulence, revealing a world governed by emergence rather than fixed form. These simulations expose a shared logic linking atomic shockwaves to galactic formations.<br><br>The project also situates this transformation within a broader epistemic shift in contemporary visual culture. In recent science fiction, from <em>Foundation</em> to <em>Dune</em>, luminous holograms give way to dense particle formations known as “sandograms.” This shift expresses a more material and embodied understanding of the virtual. It marks a transition from a world assumed to be fully rationalizable to one structured by opacity and complexity. The locus of awe moves from the divine unknown to the unknowable operations of artificial intelligence. Through these algorithmic clouds, Pigmentarium investigates notions of determinism, destiny, and free will in the age of AI. Just as the medieval soothsayer predicted the future through the “science of the sands,” contemporary systems rely on algorithmic sands to model and anticipate it. Particle images function as operative models that render randomness and causality perceptible. Knowledge is no longer extracted from stable symbols but generated through simulation.',
		},
		{
			type: 'S8',
			media: {
