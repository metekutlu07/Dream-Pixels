export default {
	...
	sections: [ {
		...
		points: [
			{
				title: 'Palace of Porphyrygenitus',
			...
			{
				title: 'Hagia Sophia',
				paragraphs: 'Built by the eastern Roman emperor Justinian I as the Christian cathedral of Constantinople for the state church of the Roman Empire between 532 and 537, the church was then the worlds largest interior space and among the first to employ a fully pendentive dome.\nIt is considered the epitome of Byzantine architecture and is said to have "changed the history of architecture". The building was designed by the Greek geometers Isidore of Miletus and Anthemius of Tralles.',
				media: { source: 'public/virtual-miniature/002.jpg', caption: 'Hagia Sophia' },
				color: 'blue'
			},
			{ title: 'Tower of Adrianopole', color: 'pink' },
			{ title: 'Amalfitan tower', color: 'yellow' },
			{ title: 'Pisan tower', color: 'green' },
			{ title: 'Golden gate', color: 'yellow' },
			{ title: 'Armenian Quarter of Psamatia', color: 'pink' }
		]
